...
type v2IncidentRule struct {
	DisplayType int `json:"display_type" required:"true" doc:"Pokestop-event id (e.g. a Showcase/Kecleon event). Resolves to the event's lowercased name as the stored grunt_type. (required)"`
